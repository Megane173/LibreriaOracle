...
//        }
        ...
        }else if( (int) libro[2]>2026 || (int) libro[2]<1200 ){
            return "Error: El numero de año del libro es poco realista";
